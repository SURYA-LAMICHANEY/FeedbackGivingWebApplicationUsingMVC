...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*" import="guideMe.model.Academic"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>Academic Acknowledgement</title>
...
<body>
<div class="navbarx">
<a href="#"><font color="white" size="6">Academic Acknowledgement</font></a></div>
<div class="navbar">
<a href="Teacher.jsp"><font color="white" size="4">Home</font></a></div>
<div class="scroll">
<c:if test = "${list == '[]'}">
